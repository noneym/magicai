    ...
    <div class="flex grow items-center justify-end gap-4">
        <div class="flex gap-2">
            ...
            >
                ...
                >
                    <button
                        class="border-none px-3 py-1 text-3xs font-medium"
                        id="export_pdf"
                        onclick="exportAsPdf();"
                    >
                        {{ __('PDF') }}
                    ...
                    <button
                        class="border-x border-x-primary-foreground/20 px-2.5 py-1 text-3xs font-medium"
                        id="export_word"
                    ...
                    <button
                        class="px-3 py-1 text-3xs font-medium"
                        id="export_txt"
                        onclick="exportAsTxt();"
                    >
                        {{ __('Txt') }}
