...
@section('content')
    ...
    <div class="py-10">
        <div
            class="chats-wrap relative grid h-[calc(100vh-7rem)] grid-flow-row md:h-[75vh] md:grid-flow-col md:[grid-template-columns:25%_1fr]"
            id="user_chat_area"
    ...
    <template id="chat_ai_bubble">
        <div class="lqd-chat-ai-bubble group mb-2 flex content-start gap-2">
            ...
            <div
                ...
                <div class="inline-flex items-center rounded-full font-medium leading-none">
                    @if ($category->slug == 'ai_chat_image')
                        <div class="loader_image loader_image_bubble lqd-typing lqd-typing-loader relative"></div>
                    @endif
                    <pre
                        class="chat-content relative w-full whitespace-pre-wrap px-6 py-3 indent-0 font-[inherit] text-xs font-normal [word-break:break-word] empty:hidden [&_p]:mb-4 [&_p]:last:mb-0 [&_pre]:!mt-4 [&_pre]:-mb-2"></pre>
                    <button
